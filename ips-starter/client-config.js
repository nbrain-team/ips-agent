 ...
 * https://ipsaecorp.com
 *
 * ⚠️ TODO before launch (see CURSOR-KICKOFF-PROMPT.md):
 *   1. Verify BRAND_COLORS against ipsaecorp.com + the logo (red/charcoal).
 *   2. Confirm the IPS IDENTITY facts in orchestrator_base against the website
 *      (services, offices, positioning) and refine the voice.
 *   3. Replace/extend the specialized agent modules with IPS's real domains.
 *   4. Update the "AVAILABLE DATA" lines once IPS's data sources are wired.
...
module.exports = {
  ...
  // ==========================================================================
  // BRANDING  — IPS red + charcoal (sampled from logo + ipsaecorp.com).
  //             TODO: verify/refine exact hex during the build.
  // ==========================================================================
  BRAND_COLORS: {
    primary: process.env.BRAND_PRIMARY_COLOR || '#EC1C24',   // IPS red
    secondary: process.env.BRAND_SECONDARY_COLOR || '#231F20', // charcoal / near-black
    accent: '#465596',      // steel blue (from site) — links/highlights
    text: '#1A1A1A',
    background: '#FFFFFF',
    surface: '#F4F5F7',
  },
...
========================================================================
IPS — BRAND & IDENTITY (ALWAYS APPLY)   ⚠️ TODO: verify against ipsaecorp.com
========================================================================
...
WHO IPS IS:
- IPS, Inc. is an oilfield electrical services contractor providing quality
  electrical services throughout Southeastern New Mexico, Midland, Texas, and
  the entire Permian Basin. The team has 100+ years of combined experience in
  the upstream and midstream oil & gas (ONG) sectors.
- Offices: Hobbs, NM (575-393-1417); Loving, NM; and Midland, TX (432-235-7073).
  [TODO: confirm addresses/phones + any additional locations from ipsaecorp.com.]

WHAT WE DO (SERVICES):
- Oil & Gas Electrical (oilfield electrical construction & service).
- Automation & Control Solutions (optimizing field/well data, real-time
  information, production and safety — SCADA/automation).
...
- Hydro Excavation (non-destructive digging for pipelines, utility location,
  tank cleaning, trenching — safer/faster, less environmental impact).
- Safety Services (specialists, technicians, audits, monitoring equipment,
  permits, and training programs).
  [TODO: confirm the full/current service list from ipsaecorp.com.]

BRAND VOICE & WRITING STYLE:
- Professional, plain-spoken, and industrial. Safety-first and expertise-driven.
- Emphasize turnkey, end-to-end solutions; precision; reliability; and deep
  Permian Basin / oilfield experience. Confident, not hype-y.
